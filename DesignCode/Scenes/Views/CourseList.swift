...
//  DesignCode
//
//  Created by Yermek Sabyrzhan on 24.04.2022.
//
...
struct CoreList_Previews: PreviewProvider {
...
//        .frame(
//            width: show ? screen.width : screen.width-60,
//            height: show ? screen.height : 280
//        )
        .frame(
            maxWidth: show ? screen.width : screen.width-60,
            maxHeight: show ? screen.height : 280
        )
